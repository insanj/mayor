...
public class MayorSchematicHandler {
    public final MayorPlugin plugin;

    public MayorSchematicHandler(MayorPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void pasteSchematic(World world, Location loc, MayorSchematic schematic) {
